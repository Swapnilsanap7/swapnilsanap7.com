...
import { trackContactForm } from '../../../lib/config/analytics';
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mjkjjjgy', {
        method: 'POST',
        headers: {
        ...
        <div ref={formRef} className="flex-1 w-full max-w-xl">
          ...
          {submitStatus === 'error' && (
            <div className="mb-6 p-4 bg-red-500/20 border border-red-500/50 rounded-lg">
              ...
              <p className="text-red-300 text-sm mt-1">Please try again or contact me directly at swapnilsanap7@gmail.com</p>
            </div>
          )}
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--dark)] dark:text-white font-medium">swapnilsanap7@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[var(--dark)] dark:text-white font-medium">Pune, MH, India</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-blue-500/20 hover:bg-blue-500 rounded-full flex items-center justify-center transition-colors group">
